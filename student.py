...
# 완벽하게 조율된 상북중 전학년 CEU 및 학생 명렬 데이터
RAW_DATA = [
    ...
    if not cls_devices.empty:
        ...
        with st.form("edit_form"):
            ...
            new_status = st.radio("상태 변경", ["이상 없음", "대여 중", "파손/점검", "분실"], 
                                   index=["이상 없음", "대여 중", "파破損/점검", "분실"].index(current_row['상태']) if current_row['상태'] in ["이상 없음", "대여 중", "파손/점검", "분실"] else 0)
